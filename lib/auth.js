...
export async function ensureUserRolesSchema() {
  await query(`alter table users drop constraint if exists users_role_check`);
  await query(
    `alter table users add constraint users_role_check check(role in ('Super Admin','Manager','Staff','Viewer','Admin','Administrator','Operator'))`,
  );
}
